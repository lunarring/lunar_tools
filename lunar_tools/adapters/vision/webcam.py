"""Camera adapter providing a threaded OpenCV capture."""
...
try:
    ...
    require_extra("WebCam", extras="camera")

from lunar_tools.platform.runtime import get_os_type
...
class WebCam:
    def __init__(
        self,
        cam_id: int | str = 0,
        shape_hw: tuple[int, int] = (576, 1024),
        do_digital_exposure_accumulation: bool = False,
        exposure_buf_size: int = 3,
    ):
        """
        Args:
