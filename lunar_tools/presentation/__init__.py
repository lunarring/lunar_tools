...
This module exposes several optional features. Importing an attribute will
load its implementation on demand and raise a helpful error if the matching
extra (e.g. ``pip install lunar_tools[display]``) is not installed.
"""
